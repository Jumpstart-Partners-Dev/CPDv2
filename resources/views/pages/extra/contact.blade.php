...
@section('content')
<div class="" style="background: #bfbfbf;padding: 54px;">
    <section class="w-full max-w-2xl px-6 py-4 mx-auto bg-white rounded-md shadow-md">
        ...
        <p class="mt-3 text-center text-gray-600">Want to be our partner? Or have anything to complain? Feel free to contact us or send us a message directly from the form below.</p>
        
        <div class="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3">
            <a href="#" class="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-200 transform rounded-md hover:bg-blue-200 dark:hover:bg-blue-500">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" />
                </svg>

                <span class="mt-2">Miami, Florida</span>
            </a>
            ...
            <a href="#" class="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-200 transform rounded-md hover:bg-blue-200 dark:hover:bg-blue-500">
                ...
                <span class="mt-2">admin@couponsplusdeals.com</span>
            </a>
        </div>
        ...
        <div class="mt-6 ">
            ...
            <div class="w-full mt-4">
                ...
                <textarea class="block w-full h-40 px-4 py-2 text-gray-700 bg-white border rounded-md focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"></textarea>
            </div>
